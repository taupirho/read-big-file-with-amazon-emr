...
with C, Python, spark-python and spark-scala. You can see my other articles on this topic here:
...
Just to recap, the data file is about 21 Gigabtyes long and holds approximately 366 Million pipe separated records. The first 
